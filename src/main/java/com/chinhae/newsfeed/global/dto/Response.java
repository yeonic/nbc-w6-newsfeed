package com.chinhae.newsfeed.global.dto;

import com.chinhae.newsfeed.global.dto.paging.PagingRes;
...
public class Response<T> {
  ...
  private PagingRes page;

  private Response(T data) {
    this.data = data;
  }

  private Response(T data, PagingRes page) {
    this.data = data;
    this.page = page;
  }
